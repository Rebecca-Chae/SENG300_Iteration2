...
public class SoftwareTest {
	...
	public static void setUp() throws Exception 
	{
		...
		BarcodedProduct appleProduct = new BarcodedProduct(b1, "Apple", new BigDecimal(1.00));
		...
		BarcodedProduct sodaProduct = new BarcodedProduct(b2, "Soda", new BigDecimal(2.00));
		...
		BarcodedProduct chipsProduct = new BarcodedProduct(b3, "Chips", new BigDecimal(3.00));
		...
		BarcodedProduct chocolateProduct = new BarcodedProduct(b4, "Chocolate Bar", new BigDecimal(4.00));
	...
	public void testGetTotalPrice() {
		AddItem.resetTotal();
		dummyAddItem.barcodeScanned(testStation.scanner, b1); // $1 100g
		dummyAddItem.barcodeScanned(testStation.scanner, b4); // $4 30g
	...
	public void testGetTotalWeight() {
		...
		dummyAddItem.barcodeScanned(testStation.scanner, b1); // $1 100g
		dummyAddItem.weightChanged(testStation.scale, 100);
		dummyAddItem.barcodeScanned(testStation.scanner, b4); // $4 30g
		dummyAddItem.weightChanged(testStation.scale, 30);
	...
	public void testRemoveScannedItem_ItemScanned() {
		...
		dummyAddItem.barcodeScanned(testStation.scanner, b2);
		dummyAddItem.barcodeScanned(testStation.scanner, b3);
		dummyAddItem.barcodeScanned(testStation.scanner, b1);
	...
	public void testWeightChanged_expectedLessThanActualChange() {
		dummyAddItem.barcodeScanned(testStation.scanner, b1);
		dummyAddItem.weightChanged(testStation.scale,  150.00);
	...
	public void testWeightChanged_expectedMoreThanActualChange() {
		dummyAddItem.barcodeScanned(testStation.scanner, b1);
		dummyAddItem.weightChanged(testStation.scale,  50.00);
		testDisableAllButScale();
	}
	...
	public void testWeightChanged_expectedEqualsActualChange() {
		dummyAddItem.barcodeScanned(testStation.scanner, b1);
		dummyAddItem.weightChanged(testStation.scale,  100.00);
		assertEquals(100.00, AddItem.getTotalWeight(), 0.001);
	}
	
	@Test
	public void testOverload() {
		dummyAddItem.overload(testStation.scale);
		testDisableAllButScale();
	}

	@Test
	public void testOutOfOverload() {
		dummyAddItem.outOfOverload(testStation.scale);
		assertFalse(testStation.scanner.isDisabled());
	}
	
	@Test
	public void testDisableAllButScale() {
		dummyAddItem.disableAllButScale();
		assertTrue(testStation.scanner.isDisabled());
		...
		assertFalse(testStation.scale.isDisabled());
	}
	...
	public void testAddProductAndItemByBarcode() {
		...
		BarcodedProduct testProduct = new BarcodedProduct(b, "Test", new BigDecimal(1.00));
	...
	public void testWouldLikeToCheckOutAmountDuePass() {
		...
		dummyAddItem.barcodeScanned(testStation.scanner, b2);
		dummyAddItem.barcodeScanned(testStation.scanner, b3);
		dummyAddItem.barcodeScanned(testStation.scanner, b4);
	...
	public void testWouldLikeToCheckOutPass() {
		...
		Assert.assertTrue(testStation.scale.isDisabled());
		Assert.assertTrue(testStation.scanner.isDisabled());
	...
	public void testreturnToScanning() 
	{
		...
		//assert
		Assert.assertFalse(testStation.scale.isDisabled());
		Assert.assertFalse(testStation.scanner.isDisabled());
		Assert.assertTrue(testStation.coinValidator.isDisabled());
		Assert.assertTrue(testStation.banknoteValidator.isDisabled());
	}
